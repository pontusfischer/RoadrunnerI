from PyTango import *
import time
print "Homing beamstop y"
con1 = DeviceProxy("p11/galildmc/eh.04")
con1.command_inout("WriteRead","SDG=2000000")
dev = DeviceProxy("p11/motor/eh.t2.07")
...
time.sleep(0.5)
dev.command_inout("Calibrate",-7968)
print "Moving to 0"
